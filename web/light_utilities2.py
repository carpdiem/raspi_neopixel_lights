...
def colorWipeFast(pixels, color):
    pixels.fill(color)
...
def try_all_color_temperatures(strip):
        ...
        colorWipe(strip, (255, 147, 41), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (255, 197, 143), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (255, 214, 170), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (255, 241, 224), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (255, 250, 244), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (255, 255, 251), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (255, 255, 255), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (201, 226, 255), wait_ms = 0.0)
        time.sleep(1.0)
        colorWipe(strip, (64, 156, 255), wait_ms = 0.0)
        time.sleep(1.0)

def initialize_strip():
    # Create NeoPixel object with appropriate configuration.
    pixels = neopixel.NeoPixel(LED_PIN, LED_COUNT, brightness = LED_BRIGHTNESS, pixel_order = ORDER)
    return pixels

def logarithmic_intensity(x):
    return 255 * (2.**(5 * x) - 1) / (2.**5 - 1)

def lights_on(pixels, temp, brightness):
    rgb = plancksLaw(temp)
    ...
    colorWipeFast(pixels, (red, green, blue))

def lights_off(pixels):
    colorWipeFast(pixels, (0, 0, 0))



# This part down here is totally fucked due to updates in the adafruit neopixel libraries and needs to be rewritten
